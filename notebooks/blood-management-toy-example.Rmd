...
from notebooks.utils import (
  create_network, solve_network, #ToDo: Remove
  optimization_step, 
  transition_function,  
  solution_to_df,
...
```{python}
def optimization_step_deprecated(supply, demand, allowed_blood_transfers, 
    reward_map, V=dict()):
      #ToDo: Remove
...
def update_value_function_deprecated(V, duals, alpha, monotone):
...
ggplot(value_to_plot) +
  geom_line(aes(x = supply, y = reward),
            size = 1) +
