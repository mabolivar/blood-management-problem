---
title: "Toy example - 3 epochs"
output: html_notebook
---

```{r params}
input_name <- "02-3epochs-toy"
...
# Get arcs details
separeted_arcs <- py["solution_df"] %>% as_tibble() %>% 
...
iteration_rewards <- arcs_wpos %>% as_tibble() %>% 
...
ggsave(glue("notebooks/figures/raw/{input_name}_plotting_{now_str}.png"),
       width = 8, height = 5)
